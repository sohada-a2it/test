...
function LongRangeBabyMonitor() {
  ...
  // Load JSON
  useEffect(() => {
      fetch("/data/BabyMonitor/long_range-baby-monitor.json")
      .then((res) => res.json())
      .then((data) => {
  ...
  const links = [
    { name: "Baby Monitor Home", href: "/category/baby-monitor-page/baby-monitor-home" },
    { name: "Long Range Baby Monitor", href: "/category/baby-monitor-page/long-rang-baby-monitor" },
    { name: "Camera Baby Monitor", href: "/category/baby-monitor-page/camera-baby-monitor" },
    { name: "Cheap Baby Monitor", href: "/category/baby-monitor-page/cheap-baby-monitor" },
    { name: "Sound Only Baby Monitor", href: "/category/baby-monitor-page/sound-only-baby-monitor" },
    { name: "Video Baby Monitor", href: "/category/baby-monitor-page/video-baby-monitor" },
    { name: "Vtech Baby Monitor", href: "/category/baby-monitor-page/vtech-baby-monitor" },
  ];
        ...
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50 px-3">
          ...
          <div className="hidden md:flex w-full justify-center">
            ...
            >
              ...
              <div className="bg-white p-2 md:p-5 w-full md:w-auto rounded-lg">
                ...
                <img src={popupImage || firstProduct.images?.[0]} className="w-[300px] h-[110px] md:h-[300px] rounded-lg object-contain object-top shadow-md mb-2 md:mb-4" alt={firstProduct.title} />
...
export default LongRangeBabyMonitor;